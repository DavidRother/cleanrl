...
"""
    ...
    target_entropy = -0.89 * torch.log(1 / torch.tensor(envs.single_action_space.n))
    target_kl = torch.log(torch.tensor(envs.single_action_space.n)) - target_entropy
    ...
    for global_step in progress_bar:
        ...
        if global_step > args.learning_starts:
            if global_step % args.train_frequency == 0:
                ...
                violation = torch.clamp(kl_batch - target_kl, min=0.0)
                ...
                if (global_step % (args.train_frequency * 25)) == 0:
                    ...
                    writer.add_scalar("losses/q_values", q_taken.mean().item(), global_step)
