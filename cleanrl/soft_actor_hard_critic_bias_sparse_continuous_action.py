...
def make_env(env_id, seed, idx, capture_video, run_name):
    def thunk():
        ...
        env = SparseMujoco(env, accumulation_time=50)
...
"""
    ...
    writer = SummaryWriter(f"runs_sparse/{run_name}")
    writer.add_text(
        "hyperparameters",
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            with torch.no_grad():
                ...
                min_qf_next_target = torch.min(qf1_next_target, qf2_next_target) + args.bias
