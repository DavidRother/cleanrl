...
class Args:
    ...
    meta_sigma: float = 0.05                # fixed std of q(α;μ,σ)
    meta_eta: float = 1e-3                # η in μ ← μ + η (R−b) (α−μ)/σ²
    meta_beta: float = 0.1                 # β for baseline EMA: b ← (1−β)b + β R
    meta_mu_min: float = 1e-4               # clamp μ into [μ_min, μ_max]
    meta_mu_max: float = 1.0
