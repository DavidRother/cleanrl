...
if __name__ == "__main__":
    ...
    algorithms_label_map = {"KLAC+bonus+anneal": r"KLAC", "KLAC": r"KLAC$_{-ab}$", "SAC": "SAC", "KLAC+bonus": r"KLAC$_{-a}$"}
    ...
    algorithms = [algorithms_label_map[algo] for algo in algorithms_old]
    ...
    for i, ax in enumerate(np.ravel(axes)):
        ...
        ticks = [1, (1 + v_full) // 2, v_full]  # 1 ↔ mid-point ↔ KLAC
