...
def make_env(env_id, seed, idx, capture_video, run_name, accumulation_time):
    def thunk():
        ...
        env = SparseMujoco(env, accumulation_time=accumulation_time)
...
"""
    ...
    for run_idx in range(args.n_runs):
        ...
        acc_time = args.n_sparse_steps
        # env setup
        envs = gym.vector.SyncVectorEnv(
            [make_env(args.env_id, args.seed + i, i, args.capture_video, run_name, acc_time) for i in range(args.num_envs)]
        )
