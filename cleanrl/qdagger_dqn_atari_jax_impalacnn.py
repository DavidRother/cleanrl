...
"""
    ...
    for global_step in track(range(args.offline_steps), description="offline student training"):
        ...
        if global_step % 100000 == 0:
            ...
            model_path = f"runs_old/{run_name}/{args.exp_name}-offline-{global_step}.cleanrl_model"
    ...
    if args.save_model:
        ...
        if args.upload_model:
            ...
            push_to_hub(args, episodic_returns, repo_id, "Qdagger", f"runs_old/{run_name}", f"videos/{run_name}-eval")
