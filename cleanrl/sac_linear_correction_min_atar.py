...
"""
    ...
    writer = SummaryWriter(f"runs_linear_correction/{run_name}")
    writer.add_text(
        "hyperparameters",
    ...
    for global_step in progress_bar:
        ...
        if global_step > args.learning_starts:
            if global_step % args.update_frequency == 0:
                ...
                delta1 = next_q_value - qf1_a_values  # [B]
                delta2 = next_q_value - qf2_a_values

                mean_delta = 0.5 * (delta1.mean() + delta2.mean())

                linear_loss = args.lin_coeff * mean_delta**2

                qf_loss = qf1_loss + qf2_loss + linear_loss
            ...
            if global_step % 100 == 0:
                ...
                writer.add_scalar("losses/linear_q_loss", linear_loss.item(), global_step)
                writer.add_scalar("losses/linear_delta", mean_delta.item(), global_step)
